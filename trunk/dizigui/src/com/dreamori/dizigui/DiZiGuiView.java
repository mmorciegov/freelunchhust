...
public class DiZiGuiView extends RelativeLayout {
	...
	public DiZiGuiView(Context context) {
		this(context, null);
	}
	
	public DiZiGuiView(Context context, AttributeSet attrs) {
		super(context, attrs);
		
		LayoutInflater.from(context).inflate(R.layout.dizigui_view, this, true);  
