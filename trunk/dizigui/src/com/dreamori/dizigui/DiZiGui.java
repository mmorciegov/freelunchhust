...
import com.dreamori.dizigui.PlayerService;
import com.dreamori.dizigui.DatabaseHelper;
import com.dreamori.dizigui.ParameterObject.TitleContent;
...
public class DiZiGui extends Activity implements  AdViewInterface   {

	public final static String ACTION_UPDATE_PAGE = "com.dreamori.dizigui.update_page";
	public final static String ACTION_UPDATE_PLAY_STATE = "com.dreamori.dizigui.update_play_state";
    ...
    private String[] _textContent = new String[DiZiGuiView.TEXTVIEW_COUNT];
	...
	private void UpdateTextContent()
	{
		...
		((DiZiGuiView)findViewById(R.id.text_content)).updateContent(_textContent, contentIndexString, outputSpellCount);
	}
	...
	public void ShowWholeExplanation()
	{
		...
		if( m_dbHelper.GetExplanationContent(DiZiGui.m_currentImageIndex, titleContent))
		{
	...
	class MyGestureListener extends GestureDetector.SimpleOnGestureListener{
		...
		public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX,
			...
			{
				DreamoriLog.LogDiZiGui("fling right");
				ShowNextImage(null);
			}
			else if( e1.getX() - e2.getX() < -120 ) 
			{
				DreamoriLog.LogDiZiGui("fling left");
